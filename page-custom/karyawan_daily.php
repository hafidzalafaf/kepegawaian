          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body" style="overflow: scroll;">
                <a href="karyawan_daily_form.php" class="btn btn-block btn-success" style="width: 100px;">New Task</a>
                <a href="karyawan_daily_report.php" class="btn btn-block btn-primary" style="width: 100px;">Report</a>
               <br>
                <table class="table table-bordered table-hover">
                  <thead>                  
                    <tr align="center">
                      ...
                      <th width="10%" align="center">Hasil</th>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <div class="btn-group">
                        <a href="karyawan_daily_update.php" class="btn btn-warning btn"><i class="fas fa-edit" style="color:white;"></i></a>
                        <a href="" onclick="return confirm('Yakin menghapus data ?')" class="btn btn-danger btn" ><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <tr>
