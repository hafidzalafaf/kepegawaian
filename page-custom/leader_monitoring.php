...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="karyawan_daily.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="leader_monitoring.php" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="../index_leader.php" class="nav-link">
                ...
                <table class="table table-bordered table-hover">
                  <thead>                  
                    ...
                    <tr>
                      <td>1</td>
                      <td>Putri</td>
                      <td align="center"><a href="leader_monitoring_daily.php" class="btn btn-success btn-sm">Today</a></td>
                      <td align="center"><a href="leader_monitoring_report.php" class="btn btn-primary btn-sm">Report</a></td>
                    </tr>
                  <tbody>
                  </tbody>
                </table>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="../home_leader.html">PT. Sinar Grafindo</a>. </strong>
    All rights reserved.
