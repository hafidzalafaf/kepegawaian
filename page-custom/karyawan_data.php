    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="karyawan_data.php" class="nav-link active">
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <p class="text-muted text-center">Jabatan Karyawan</p>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
               <strong><i class="fas fa-book mr-1"></i>NIP</strong>
                  <p class="text-muted">0145385734</p>
                  <strong><i class="fas fa-book mr-1"></i>Nama</strong>
                  <p class="text-muted">Norhadi</p>
                  <strong><i class="fas fa-book mr-1"></i>Tempat, Tanggal Lahir</strong>
                  <p class="text-muted">Pati, 21 Februari 1999</p>
                  <strong><i class="fas fa-book mr-1"></i>Status Pernikahan</strong>
